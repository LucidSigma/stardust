...
class SceneTemplate final
    : public sd::Scene
{
public:
    SceneTemplate(sd::Application& application, const sd::StringView name);
    virtual ~SceneTemplate() noexcept override = default;

    [[nodiscard]] virtual auto OnLoad() -> sd::Status override;
    virtual auto OnUnload() noexcept -> void override;
    ...
    virtual auto Render(sd::gfx::Renderer& renderer) -> void override;
