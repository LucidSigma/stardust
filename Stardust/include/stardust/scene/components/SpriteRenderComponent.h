...
namespace stardust
{
	namespace components
	{
		struct SpriteRender
		{
			...
			SpriteRender(const Texture& texture, const SortingLayer& sortingLayer, const Optional<TextureCoordinatePair>& subtextureArea = NullOpt, const Colour colourMod = colours::White)
